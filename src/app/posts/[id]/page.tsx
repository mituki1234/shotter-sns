...
export default function PostDetail() {
    ...
    async function fetchReplies() {
        try {
            ...
            // 日付順にソート（新しい順）
            repliesData.sort((a, b) =>  a.date - b.date);
                ...
                {loading ? (
                    ...
                    <div className="main-post">
                        ...
                        reply.map((replyItem: any, index: number) => (
                            <div key={`${replyItem.docId}-${index}`} className="reply-item">
                                <PostItem post={replyItem} handleLike={handleLike} />
                            </div>
                        ))
                    ) : (
                        <p className="no-replies">まだリプライはありません</p>
                    )}
                    </div>
                ) : (
